...
from aimacode.utils import expr #  Expr: the data type for logical sentences 
                ...
                for plane in self.planes:
                    for airport in self.airports:
                        precond_pos = [expr("In({}, {})".format(cargo, plane)),
                                      expr("At({}, {})".format(plane, airport)),]
                        precond_neg = []
                        effect_add = [expr("At({}, {})".format(cargo, airport)),] # effect : cargo  is (arrive) at the airport
                ...
                for to in self.airports:
                    if fr != to:
                        for plane in self.planes:
                            ...
                            precond_neg = []
                            effect_add = [expr("At({}, {})".format(plane, to))] # effect : plane in (fly) to destination airport
